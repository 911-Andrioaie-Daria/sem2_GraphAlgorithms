from DirectedGraph import Graph, read_graph, write_graph, create_random_graph
...
class UI:
    ...
    def get_in_degree_ui(self):
        ...
        vertex_in_degree = self.graph.get_degree(vertex_id)
    ...
    def parse_outbound_edges_of_vertex_ui(self):
        vertex_id = int(input("Enter vertex: "))
        outbound_edges = self.graph.parse_edges(vertex_id)
        if outbound_edges:
    ...
    def get_cost_of_edge_ui(self):
        ...
        edge_cost = self.graph.get_cost_of_edge(source_vertex, target_vertex)
    ...
    def update_cost_of_edge_ui(self):
        ...
        self.graph.update_cost_of_edge(source_vertex, target_vertex, new_cost)
    ...
    def remove_edge_ui(self):
        source_vertex = int(input("Source vertex: "))
        target_vertex = int(input("Target vertex: "))
        self.graph.remove_edge(source_vertex, target_vertex)
